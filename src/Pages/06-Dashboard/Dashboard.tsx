...
const Dashboard = () => {
  ...
  const [modelNDelete, setModelNDelete] = useState({
    status: false,
    id: "",
    custId: "",
  });

  const [modelHDelete, setModelHDelete] = useState({
    status: false,
    id: "",
    custId: "",
    headId: "",
    ...
    <>
      {loading ? (
        ...
        <div className="w-[100%] flex py-10 justify-center items-center flex-col">
              ...
              >
                ...
                >
                  ...
                  <div id="content-3a" className="flex-1 overflow-auto">
                    <p>
                      Are you sure you want to delete user {modelNDelete.custId}
                      ? Once deleted, all associated details will be permanently
                      removed and cannot be recovered.
                    </p>
                    <div className="flex justify-between gap-5 pt-5">
                      <div
                        className="w-[100%] bg-[#0f3b36] font-bold text-[#fff] flex justify-center items-center rounded h-12 cursor-pointer"
                        onClick={() => {
                          !nDeleteLoad &&
                            handleActiveStatus("inactive", modelNDelete.id);
                        }}
                      >
                        {nDeleteLoad ? "Loading" : "Delete"}
                      </div>
                      <div
                        onClick={() =>
                          setModelNDelete({ status: false, id: "", custId: "" })
                        }
                        className="w-[100%] bg-[#ee6868] font-bold text-[#fff] flex justify-center items-center rounded h-12 cursor-pointer"
                      >
                        Cancel
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div id="content-3a" className="flex-1 overflow-auto">
                      <p>
                        ...
                        {modelHDelete.custId}? Once deleted, all associated
                        details will be permanently removed and cannot be
                        recovered.
                      </p>
                      <div className="flex justify-between gap-5 pt-5">
                        <div
                          className="w-[100%] bg-[#0f3b36] font-bold text-[#fff] flex justify-center items-center rounded h-14 cursor-pointer"
                          onClick={() => {
                            !nDeleteLoad && handleDeleteAllUser();
                          }}
                        >
                          {nDeleteLoad ? "Loading" : "Delete All User"}
                        </div>
                        <div
                          onClick={() => {
                            setHeadDeleteStepper("2");
                          }}
                          className="w-[100%] bg-[#ee6868] font-bold text-[#fff] flex justify-center items-center rounded h-14 cursor-pointer text-[1rem] p-2"
                        >
                          Delete User & Reassign Access
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    >
                        ...
                        >
                          ...
                          <span className="relative only:-mx-5">
                            ...
                            >
                              ...
                              <desc id="desc-back">
                                A left arrow indicating the go back action
                              </desc>
                              <path
                                strokeLinecap="round"
                                strokeLinejoin="round"
                      ...
                      >
                        <div id="content-3a" className="flex-1 overflow-auto">
                          ...
                          <div className="flex justify-between gap-5 pt-5">
                            <button
                              type={nDeleteLoad ? "button" : "submit"}
                              className="w-[100%] bg-[#0f3b36] font-bold text-[#fff] flex justify-center items-center rounded h-14 cursor-pointer"
                            >
                              {nDeleteLoad ? "Loading" : "Submit"}
                            </button>
                          </div>
                        </div>
                      </form>
          ...
          <div className="font-[#333] text-[2rem] font-bold">All Users</div>
          <div className="w-[100%] flex justify-center items-center py-10 flex-col">
            {userData.map((data: any, index) => (
              <>
                {data.headStatus === "true" && (
                  <>
                    <div className=" w-[70%] lg:w-[30%] flex pb-1 font-bold text-[#234d48]">
                      Primary ID
                    </div>
                    <div
                      key={index}
                      className="mb-2 w-[70%] lg:w-[30%] bg-[#234d48] h-[60px] flex justify-between px-4 items-center rounded"
                    >
                      <div>
                      ...
                      <div>
                        <div
                          className="bg-[#fa3636] h-[1.4rem] w-[3rem] flex justify-around items-center rounded text-[#fff] cursor-pointer text-[0.8rem] font-normal"
                          onClick={() => {
                            setModelHDelete({
                              status: true,
                              id: data.refUserId,
                              custId: data.refUserCustId,
                              headId: "",
                            });
                          }}
                        >
            ...
            {userData.map((data: any, index) => (
              <>
                {data.headStatus === "false" && (
                  <div
                    key={index}
                    className="my-2 w-[70%] lg:w-[30%] bg-[#d3dfdd] h-[60px] flex justify-between px-4 items-center rounded"
                  >
                    <div>
                      <div className="text-[#ffa377] font-bold text-[0.7rem]">
                        {data.refUserCustId}

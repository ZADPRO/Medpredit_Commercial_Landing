...
const Subscription = () => {
    ...
    useEffect(() => {
        ...
        if (queryParams.get('token') && queryParams.get('packageId') && queryParams.get('refLanCode')) {
            // setAccessData({
            //     token: queryParams.get('token') || "",
            //     packageId: queryParams.get('packageId') || "",
            //     refLanCode: queryParams.get('refLanCode') || ""
    ...
    return (
        ...
        <div style={{ width: "100%", height: "100vh", backgroundColor: "#f9fff7" }}>
            {
                loading ? (
                    <>
                    ...
                    <>
                                            ...
                                            <div className="modalContent">
                                                <div className="lottie-container">
                                                    <Lottie
                                                        ...
                                                        onComplete={() =>
                                                            setTimeout(() => {
                                                                window.location.href = "medpreditcommercial://";
                        ...
                        </div>
                        {
                            upgradeInfo?.isFirstPackage == true ? (
                                <>
                                    <div style={{ height: "83vh", padding: "20px 20px", overflow: "auto" }} className="w-[100%]">



                                        <>
                                            <div style={{ fontSize: "1.2rem", fontFamily: "Inter", fontWeight: "600", display: "flex", alignItems: "flex-end", gap: "20px", color: "#0c4b41", marginTop: "-15px" }}>
                                                {selectPackage?.refPkgName}
                                            </div>

                                            <div style={{ fontSize: "1.7rem", fontFamily: "Inter", fontWeight: "700", display: "flex", alignItems: "flex-end", gap: "20px", color: "#000", marginTop: "0px" }}>
                                                {"₹ " +
                                            ...
                                            <p style={{ fontStyle: "italic", fontFamily: "Inter", fontWeight: "600", marginTop: "0px" }}>
                                                {"₹" +
                                ...
                                <>
                                    <div style={{ width: "100%", height: "83vh", padding: "20px 20px", overflow: "auto" }}>
                                        ...
                                        <>
                                            ...
                                            <div className="subscription-detail-price" style={{ fontSize: "1.7rem", fontFamily: "Inter", fontWeight: "700", display: "flex", alignItems: "flex-end", gap: "20px", color: "#000", marginTop: "0px" }}>
                                                <s>
                                                    {"₹ " +
                        ...
                        <div style={{ width: "100%", height: "9vh", padding: "0px 20px", display: "flex", justifyContent: "center", alignItems: "center", }}>
                            <div
                                style={{
                                    width: "100%",
                                    height: "6vh",
